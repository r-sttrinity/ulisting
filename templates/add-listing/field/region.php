...
<?php if(isset($attribute->title)):?>
    <div class="ulisting-form-gruop">
        ...
        <div class="stm-listing-select">
            <ulisting-select2 :options='attributes.<?php echo esc_attr($attribute->name)?>.options' :text="'name'" v-model='attributes.<?php echo esc_attr($attribute->name)?>.value' theme='bootstrap4'></ulisting-select2>
